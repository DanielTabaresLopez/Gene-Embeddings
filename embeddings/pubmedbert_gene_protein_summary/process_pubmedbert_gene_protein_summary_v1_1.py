...
EMBEDDING_NAME = "PubMedBERT-GeneProteinSummary-v1.1"
...
OUT_DIR = Path.home() / "data/processed_embeddings/pubmedbert_gene_protein_summary_v1_1"
...
def main():
    ...
    safe = "pubmedbert_gene_protein_summary_v1_1"
