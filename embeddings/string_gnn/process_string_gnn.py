#!/usr/bin/env python3
"""Download and locally process the STRING GNN gene embedding.
...
EMBEDDING_NAME = "string_gnn"
DISPLAY_NAME = "STRING GNN"
DIMENSION = 256

SOURCE_DATASET = "genbio-ai/foundation-models-perturbation"
SOURCE_REVISION = "d67ba21019814bb55dbdb448b3b84d18bbc693b8"
SOURCE_REPO_PATH = "gene_embeddings/GNN_Simple_Official_(D=256).h5ad"
SOURCE_SHA256 = "58dee3dddb3332dbff43f21225460d20fc3c75f933a4d62c71bbca4699619e25"
...
def main() -> None:
    ...
    metadata = {
        ...
        "original_method": "Residual graph convolutional network with link prediction",
